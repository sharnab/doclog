        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-custom example example-compact">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('union_update',$union['id']) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        <div class="card-body">
                        <input type="hidden" name="_method" value="PUT">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <input type="text" class="form-control" name="title" value="{{ old('title') ? old('title') : $union['title'] }}" placeholder="Union name in bangla" required>
                                    @if ($errors->has('title'))
                                    <span class="help-block">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <div class="radio-inline">
                                        <label class="radio">
                                        <input type="radio" name="active_status" value="Active" {{ (isset($union['active_status'])&&$union['active_status']=='Active')||(old('active_status') != 'Inactive')?'checked':'' }}  > Yes<span></span>
                                        </label>
                                        <label class="radio">
                                        <input type="radio" name="active_status" value="Inactive" {{ (isset($union['active_status'])&&$union['active_status']=='Inactive')||(old('active_status') == 'Inactive')?'checked':'' }}  > No<span></span>
                                        </label>
