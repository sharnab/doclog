...
@section('content')
    ...
    <div class="page-head">
        ...
        <div class="page-title">
            <h1>District <small>New</small></h1>
        </div>
        <!-- END PAGE TITLE -->
        ...
        <div class="col-md-12">
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-home"></i>Create New District
                    </div>
                ...
                <div class="portlet-body">
                    ...
                    {{ Form::open(['route' => 'district_store' , 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']) }}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-md-6 {{ $errors->has('title_en') ? 'has-error' : '' }}">
                                    <input type="text" class="form-control" name="title_en" value="{{ old('title_en') }}" placeholder="District name in english" style="text-transform:uppercase" required>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-md-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        ...
                                        <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="District name in bangla" required>
                                        @if ($errors->has('title'))
                                        <span class="help-block">
