...
@section('content')
    ...
    <div class="page-head">
        ...
        <div class="page-title">
            <h1>Division <small>New</small></h1>
        </div>
        <!-- END PAGE TITLE -->
        ...
        <div class="col-md-12">
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-home"></i>Create New Division
                    </div>
                ...
                <div class="portlet-body">
                    ...
                    {{ Form::open(['route' => 'division_store' , 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']) }}
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-md-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        ...
                                        <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Division name in bangla" required>
                                        @if ($errors->has('title'))
                                        <span class="help-block">
