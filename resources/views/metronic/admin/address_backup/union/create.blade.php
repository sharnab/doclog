        ...
        <div class="col-md-12">
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-home"></i>Create New Union
                    </div>
                ...
                <div class="portlet-body">
                    ...
                    {{ Form::open(['route' => 'union_store' , 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']) }}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-md-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Union name in english" required>
                                    @if ($errors->has('title'))
                                    <span class="help-block">
