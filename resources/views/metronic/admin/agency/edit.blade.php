            ...
            <div class="col-md-12">
                ...
                <div class="card card-custom example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Edit Recruiting Agency</h3>
                    ...
                    <!--begin::Form-->
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('agency_update',$agency['id']) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('agency_name') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="agency_name" value="{{ old('agency_name')? old('agency_name') : $agency['agency_name'] }}" placeholder="Agency Name" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('licence_no') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="licence_no" value="{{ old('licence_no')? old('licence_no') : $agency['licence_no'] }}" placeholder="Licence Number" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('agent_name') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="agent_name" value="{{ old('agent_name')? old('agent_name') : $agency['agent_name'] }}" placeholder="Agent name" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('agent_position') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="agent_position" value="{{ old('agent_position')? old('agent_position') : $agency['agent_position'] }}" placeholder="Agent Position" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('address') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="address" value="{{ old('address')? old('address') : $agency['address'] }}" placeholder="Agency Address" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('agent_address') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text" name="agent_address" value="{{ old('agent_address')? old('agent_address') : $agency['agent_address'] }}" placeholder="Agent Address" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('email') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="email" value="{{ old('email')? old('email') : $agency['email'] }}" placeholder="Email Address" required />
                                    @if ($errors->has('email'))
                                    <span class="form-text text-muted">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('land_phone') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="land_phone" value="{{ old('land_phone')? old('land_phone') : $agency['land_phone'] }}" placeholder="Land Phone Number" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('mobile') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="mobile" value="{{ old('mobile')? old('mobile') : $agency['mobile'] }}" placeholder="Mobile Number" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div id="datepicker" class="col-10 input-group date {{ $errors->has('renewed_upto_date') ? 'has-error' : '' }}" data-date-format="yyyy-mm-dd">
                                    ...
                                    <input type="text" class="form-control" placeholder="Licence Valid Date" name='renewed_upto_date' value="{{ old('mobile')? old('renewed_upto_date') : $agency['renewed_upto_date'] }}" readonly>
                            ...
                            <!-- <div class="form-group row">
                                <label class="col-2 col-form-label">Latitude<i style="color: red">*</i></label>
                                <div class="col-10 {{ $errors->has('lat') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="lat" value="{{ old('lat')? old('lat') : $agency['lat'] }}" placeholder="Latitude" required />
                                    @if ($errors->has('lat'))
                                    <span class="form-text text-muted">
                            ...
                            <div class="form-group row">
                                <label class="col-2 col-form-label">Longitude<i style="color: red">*</i></label>
                                <div class="col-10 {{ $errors->has('lon') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text" name="lon" value="{{ old('lon')? old('lon') : $agency['lon'] }}" placeholder="Longitude" required />
                                    @if ($errors->has('lon'))
                                    <span class="form-text text-muted">
