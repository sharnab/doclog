                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <!--begin::Input-->
                                                                    <div class="form-group">
                                                                        <label><mark style="color: red; background: white">*</mark>Street:</label>
                                                                        <div class="input-group date mb-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    <!--begin::Input-->
                                                                    <div class="form-group">
                                                                        <label><mark style="color: red; background: white">*</mark>Area:</label>
                                                                        <div class="input-group date mb-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    <!--begin::Input-->
                                                                    <div class="form-group">
                                                                        <label><mark style="color: red; background: white">*</mark>City:</label>
                                                                        <div class="input-group date mb-2">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    <!--begin::Input-->
                                                                    <div class="form-group">
                                                                        <label><mark style="color: red; background: white">*</mark>Name:</label>
                                                                        <div class="input-group date mb-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date mb-2">
                                                                            <input name="street_name" type="text" class="form-control form-control-solid" placeholder="Enter street/para" />
                                                                        </div>
                                                                        {{-- <span class="form-text text-muted">Please enter your arrival country</span> --}}
                                                                    </div>
                                                                    <!--end::Input-->
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control religion" id="kt_select_1" name="division_id" required>
                                                                            <option value='null'>Select Division</option>
                                                                            @foreach ($divions as $divion)
                                                                            <option value="{{ $divion->id }}">
                                                                                {{ $religion->title }}
                                                                            </option>
                                                                            @endforeach
                                                                        </select>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date mb-2">
                                                                            <input name="district" type="text" class="form-control form-control-solid" placeholder="Enter district" />
                                                                        </div>
                                                                        {{-- <span class="form-text text-muted">Please enter your arrival country</span> --}}
                                                                    </div>
                                                                        {{-- <span class="form-text text-muted">Please enter immigration endorsement date</span> --}}
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date mb-2">
                                                                            <input name="thana" type="text" class="form-control form-control-solid" placeholder="Enter thana/upazilla" />
                                                                        </div>
                                                                        {{-- <span class="form-text text-muted">Please enter your arrival country</span> --}}
                                                                    </div>
                                                                    <!--end::Input-->
                                                                ...
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date mb-2">
                                                                            <input name="word" type="text" class="form-control form-control-solid" placeholder="Enter word" />
                                                                        </div>
                                                                        {{-- <span class="form-text text-muted">Please enter your arrival country</span> --}}
                                                                    </div>
                                                                        {{-- <span class="form-text text-muted">Please enter immigration endorsement date</span> --}}
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date mb-2">
                                                                            <input name="area" type="text" class="form-control form-control-solid" placeholder="Enter area/village" />
                                                                        </div>
                                                                        {{-- <span class="form-text text-muted">Please enter your arrival country</span> --}}
                                                                    </div>
                                                                    <!--end::Input-->
                                                                ...
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group date mb-2">
                                                                            <input name="post_office" type="text" class="form-control form-control-solid" placeholder="Enter post office" />
                                                                        </div>
                                                                        {{-- <span class="form-text text-muted">Please enter your arrival country</span> --}}
                                                                    </div>
                                                                        {{-- <span class="form-text text-muted">Please enter immigration endorsement date</span> --}}
