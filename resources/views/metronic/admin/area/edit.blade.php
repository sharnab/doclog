        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">Area</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('area') }}" class="text-muted">Area</a>
                        </li>
                        <li class="breadcrumb-item">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <div class="example-tools justify-content-center">
                                    <a href="{{ route('area') }}"><button type="button" class='btn btn-primary mr-2'>Back</button></a>
                                </div>
                            </div>
                        </div>
                        <!--begin::Form-->
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('area_update',$item->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="form-group required">
                                            ...
                                            {{ Form::text('name_en',$item->name_en,['class'=>'form-control','required'=>true]) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('name_bn',$item->name_bn,['class'=>'form-control','required'=>true]) }}
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <a href="{{ route('area') }}" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
