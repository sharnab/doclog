        ...
        <div class="col-md-12">
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    ...
                    <a href="{{route('customer_create')}}" title="New Customer" class="panel-title-btn btn btn-icon waves-effect waves-light btn-success btn-back pull-right" > <i class="ion-plus-circled"></i> </a>
                </div>
                <div class="portlet-body">
                    <div class="">
                        @include('layouts.alert')
                        <table class="table table-striped table-hover"  id="customer">
                        <thead>
                            <tr>
                                <th>
                                    #
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ ++$sl }}</td>
                                <td>{{ $customer['sur_name'] }}</td>
                                <td>{{ $customer['contact_no'] }}</td>
                                <td>{{ isset($customer['customerType']['name']) ? $customer['customerType']['name'] : '' }}</td>
                                <td>
                                    <span class="label label-sm label-{{ $customer['active_status'] == 1 ? 'success' : 'danger' }} ">
                                    {{ $customer['active_status'] == 1 ? 'Active' : 'Inactive' }}
                                    </span>
                                </td>
                                <td>
                                    <a href="{{route('customer_edit',$customer['id'])}}" class="btn btn-icon-only purple" title="Edit">
