	...
	<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-2 mr-5">Departure</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ url('admin/'.$module_route) }}" class="text-muted">Departure</a>
                    </li>
                    <li class="breadcrumb-item">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-custom example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Edit Departure</h3>
                    ...
                    <!--begin::Form-->
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('departure_info.update',$item->id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date mb-2">
                                            <input name="departure_date" type="text" class="form-control form-control-solid" placeholder="Enter departure date" id="kt_datepicker_3" value="{{isset($item->date)?((!empty($item->date) && !is_null($item->date))?date('d-m-Y',strtotime($item->date)):''):''}}"/>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control arrival_country" id="kt_select_5" name="departure_country_id">
                                            <option value='null'>Select Country</option>
                                            @foreach ($countries as $country)
                                            <option value="{{ $country['id'] }}" {{($item->departure_country_id == $country['id'])?'selected':''}}>
                                                {{ $country['title'] }}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="departure_iata_code" type="text" class="form-control form-control-solid" placeholder="Enter airport iata code" value="{{ isset($item->iata_code)?$item->iata_code:''}}" />
                                    </div>
                                    <!--end::Input-->
                                </div>
