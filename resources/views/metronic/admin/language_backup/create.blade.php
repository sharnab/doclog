...
@section('content')
    ...
    <div class="page-head">
        ...
        <div class="page-title">
            <h1>Language <small>New</small></h1>
        </div>
        <!-- END PAGE TITLE -->
        ...
        <div class="col-md-12">
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-home"></i>Create New Language
                    </div>
                ...
                <div class="portlet-body">
                    ...
                    {{ Form::open(['route' => 'language_store' , 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']) }}

                        <div class="form-body">
                            <div class="form-group required">
                                <label class="col-md-3 control-label">Language English</label>
                                <div class="col-md-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Language name in english" required>
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group required">
                                <label class="col-md-3 control-label">Language Bangla</label>
