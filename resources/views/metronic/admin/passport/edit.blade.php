            ...
            <div class="col-md-12">
                ...
                <div class="card card-custom example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">Edit Passport Office</h3>
                    ...
                    <!--begin::Form-->
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('passport_update',$passport['id']) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('passport_name') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="passport_name" value="{{ old('passport_name')? old('passport_name') : $passport['passport_name'] }}" placeholder="Regional Passport Offices" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('address') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="address" value="{{ old('address')? old('address') : $passport['address'] }}" placeholder="Address" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('phone') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="phone" value="{{ old('phone')? old('phone') : $passport['phone'] }}" placeholder="Phone" required />
                                    @if ($errors->has('phone'))
                                    <span class="form-text text-muted">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('email') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="email" value="{{ old('email')? old('email') : $passport['email'] }}" placeholder="Email" required />
                                    @if ($errors->has('email'))
                                    <span class="form-text text-muted">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('website') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="website" value="{{ old('website')? old('website') : $passport['website'] }}" placeholder="Passport office website" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('facebook_link') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="facebook_link" value="{{ old('facebook_link')? old('facebook_link') : $passport['facebook_link'] }}" placeholder="Facebook Link" />
                            ...
                            <!-- <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('lat') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="lat" value="{{ old('lat')? old('lat') : $passport['lat'] }}" placeholder="Latitude" />
                                    @if ($errors->has('lat'))
                                    <span class="form-text text-muted">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('lon') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="lon" value="{{ old('lon')? old('lon') : $passport['lon'] }}" placeholder="Longitude" />
                                    @if ($errors->has('lon'))
                                    <span class="form-text text-muted">
