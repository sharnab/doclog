...
@section('content')
    ...
    <div class="page-head">
        ...
        <div class="page-title">
            <h1>Religion <small>New</small></h1>
        </div>
        <!-- END PAGE TITLE -->
        ...
        <div class="col-md-12">
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-home"></i>Create New Religion
                    </div>
                ...
                <div class="portlet-body">
                    ...
                    {{ Form::open(['route' => 'religion_store' , 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']) }}

                        <div class="form-body">
                            <div class="form-group required">
                                <label class="col-md-3 control-label">Religion English</label>
                                <div class="col-md-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Religion name in english" required>
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group required">
                                <label class="col-md-3 control-label">Religion Bangla</label>
                                <div class="col-md-6 {{ $errors->has('title_bn') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        
                                        <input type="text" class="form-control" name="title_bn" value="{{ old('title_bn') }}" placeholder="Religion name in bangla" required>
