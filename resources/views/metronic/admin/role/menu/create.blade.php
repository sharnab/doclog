	...
	<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-2 mr-5">New Menu</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 {{ $errors->has('title') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Menu Title" required>
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 {{ $errors->has('alt_title') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" name="alt_title" value="{{ old('alt_title') }}" placeholder="Alternative Menu Title" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 input-group">
                                ...
                                <input class="form-control" readonly="" name="icon" type="text" id="icon">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 {{ $errors->has('order') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" name="order" value="{{ old('order') }}" placeholder="Order" id='order'>
                                @if ($errors->has('order'))
                                <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10 checkbox-inline">
                                <label class="checkbox">
                                    <input type="checkbox" name="status" value=1 {{ (isset($menu['status'])&&$menu['status']=='Active')||(old('status') != 2)?true:false }}  > <span></span>
                                </label>
                            </div>
                        </div>
                    </div>
