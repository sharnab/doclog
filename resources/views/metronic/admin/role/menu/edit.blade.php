	...
	<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-2 mr-5">Edit Menu</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="{{ url('admin/permissions/menu') }}"><button type="button" class='btn btn-primary mr-2'>Back</button></a>
                        </div>
                    </div>
                </div>
                <!--begin::Form-->
                <form class="form-horizontal" role="form" method="POST" action="{{ route('menu.update',$menu['id']) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-form-label text-right col-lg-2 col-sm-12">Parent Menu<i style="color: red">*</i></label>
                            <div class="col-lg-10 col-md-10 col-sm-12" {{ $errors->has('parent_id') ? 'has-error' : '' }}>
                                <select class="form-control select2" id="kt_select2_1" name="parent_id" required>
                                    <option value="null">None</option>
                                    @foreach ($menus as $menu1)
                                        
                                        <option value="{{ $menu1->id }}" {{ ( $menu1->id == $menu['parent_id']) ? "selected" : "" }}>{{ $menu1->title }}</option>
                                    @endforeach
                        ...
                        <div class="form-group row">
                            <label class="col-form-label text-right col-lg-2 col-sm-12">Title<i style="color: red">*</i></label>
                            <div class="col-md-10 {{ $errors->has('title') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" name="title" value="{{ old('title')? old('title') : $menu['title'] }}" placeholder="Menu Title" required>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label text-right col-lg-2 col-sm-12">Alternative Title<i style="color: red">*</i></label>
                            <div class="col-md-10 {{ $errors->has('alt_title') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" name="alt_title" value="{{ old('alt_title')? old('alt_title') : $menu['alt_title'] }}" placeholder="Alternative Menu Title" required>
                                @if ($errors->has('alt_title'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('alt_title') }}</strong>
                                </span>
                                @endif
                            </div>
                        ...
                        <div class="form-group row">
                            <label class="col-form-label text-right col-lg-2 col-sm-12">URI<i style="color: red">*</i></label>
                            <div class="col-lg-10 col-md-10 col-sm-12">
                                <select class="form-control select2" id="kt_select2_2" name="uri" required >
                                    <option value=''>Select URI</option>
                                @foreach ($all_routes as $key=>$value)
                                    <!-- <option value="{{ $key }}"> 
                                        {{ $value }} 
                                    </option> -->
                                    <option value="{{ $key }}" {{ ( $value == $menu['uri']) ? "selected" : "" }}>{{ $value }} </option>
                                @endforeach
                        ...
                        <div class="form-group row">
                            <label class="col-form-label text-right col-lg-2 col-sm-12">URL<i style="color: red">*</i></label>
                            <div class="col-md-10 {{ $errors->has('url') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" id='url' name="url" value="{{ old('url')? old('url') : $menu['url'] }}" placeholder="URL" required>
                                @if ($errors->has('url'))
                                <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="icon" class="col-form-label text-right col-lg-2 col-sm-12">Icon</label>
                            <div class="col-md-10 input-group">
                                <!-- {{ Form::text('icon',!isset($menu)?'md md-apps':null,['class'=>'form-control','readonly']) }} -->
                                <input class="form-control" readonly="" name="icon" type="text" value="{{ old('icon')? old('icon') : $menu['icon'] }}" id="icon">
                        ...
                        <!--end: Code-->
                        <div class="form-group row">
                            <label class="col-form-label text-right col-lg-2 col-sm-12">Order</label>
                            <div class="col-md-10 {{ $errors->has('order') ? 'has-error' : '' }}">
                                <input type="text" class="form-control" name="order" value="{{ old('order')? old('order') : $menu['order'] }}" placeholder="Order" id='order'>
                                @if ($errors->has('order'))
                                <span class="help-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10 {{ $errors->has('description') ? 'has-error' : '' }}">
                                <textarea type="text" class="form-control" name="description" placeholder="Description" >{{$menu['description']}}</textarea>
                        ...
                        <div class="form-group row">
                            <label  class="col-form-label text-right col-lg-2 col-sm-12">Is Active</label>
                            <div class="col-10 checkbox-inline">
                                <label class="checkbox">
                                    <!-- <input type="checkbox" name="status" value=1 {{ (isset($menu['status'])&&$menu['status']==1)||(old('status') != 2)?true:false }}  > <span></span> -->

                                    <input type="checkbox" name="status" value=1 {{ (isset($menu['status'])&&$menu['status']==1)?'checked':'' }}  ><span></span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-10">
                                ...
                                <a href="{{ url('admin/permissions/menu') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
