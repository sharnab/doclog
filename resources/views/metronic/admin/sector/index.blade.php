        ...
        <div class="col-md-12">
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    ...
                    <a href="{{route('sector_create')}}" title="New Sector" class="panel-title-btn btn btn-icon waves-effect waves-light btn-success btn-back pull-right" > <i class="ion-plus-circled"></i> </a>
                </div>
                <div class="portlet-body">
                    <div class="">
                        @include('layouts.alert')
                        <table class="table table-striped table-hover"  id="sector">
                        <thead>
                            <tr>
                                <th>
                                    #
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $sector['name'] }}</td>
                                <td>
                                    {{ $sector['type'] == 1 ? 'International' : 'Local' }}
                                </td>
                                <td>
                                    <span class="label label-sm label-{{ $sector['active_status'] == 1 ? 'success' : 'danger' }} ">
                                    {{ $sector['active_status'] == 1 ? 'Active' : 'Inactive' }}
                                    </span>
                                </td>
                                <td>
                                    <a href="{{route('sector_edit',$sector['id'])}}" class="btn btn-icon-only purple" title="Edit">
