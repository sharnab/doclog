        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-custom example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('skill_store') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="title" value="{{ old('title') }}" placeholder="Skill name in english" required />
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('title_bn') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="title_bn" value="{{ old('title_bn') }}" placeholder="Skill name in bangla" required />
