        ...
        <div class="col-md-12">
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-home"></i>Create New Skill
                    </div>
                ...
                <div class="portlet-body">
                    ...
                    {{ Form::open(['route' => 'skill_store' , 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data']) }}

                        <div class="form-body">
                            <div class="form-group required">
                                <label class="col-md-3 control-label">Skill English</label>
                                <div class="col-md-6 {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Skill name in english" required>
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group required">
                                <label class="col-md-3 control-label">Skill Bangla</label>
                                <div class="col-md-6 {{ $errors->has('title_bn') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        
                                        <input type="text" class="form-control" name="title_bn" value="{{ old('title_bn') }}" placeholder="Skill name in bangla" required>
