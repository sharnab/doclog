            ...
            <div class="col-md-12">
                ...
                <div class="card card-custom example example-compact">
                    <div class="card-header">
                        <h3 class="card-title">New Training Center</h3>
                    ...
                    <!--begin::Form-->
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('training_center_store') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-2 col-form-label">Division<i style="color: red">*</i></label>
                                <div class="col-10 {{ $errors->has('division_id') ? 'has-error' : '' }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('office_name') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text" name="office_name" value="{{ old('office_name') }}" placeholder="Office Name" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('area') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text" name="area" value="{{ old('area') }}" placeholder="Area" required />
                                    @if ($errors->has('area'))
                                    <span class="form-text text-muted">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('year_of_establishment') ? 'has-error' : '' }}">
                                    <input class="form-control" type="number" name="year_of_establishment" value="{{ old('year_of_establishment') }}" placeholder="Year of Establishment" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('year_of_operation') ? 'has-error' : '' }}">
                                    <input class="form-control" type="number" name="year_of_operation" value="{{ old('year_of_operation') }}" placeholder="Year of Starting Operation" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('present_principal') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="present_principal" value="{{ old('present_principal') }}" placeholder="Present Principal" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('land_phone') ? 'has-error' : '' }}">
                                    <input class="form-control" type="text"name="land_phone" value="{{ old('land_phone') }}" placeholder="Land Phone" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 {{ $errors->has('mobile') ? 'has-error' : '' }}">
                                    <input class="form-control" type="number" name="mobile" value="{{ old('mobile') }}" placeholder="Mobile" required />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <div class="radio-inline">
                                        <label class="radio">
                                            <input type="radio" name="active_status" value="Active" {{ (isset($training_center['active_status'])&&$training_center['active_status']=='Active')||(old('active_status') != 'Inactive')?'checked':'' }}  > Yes<span></span>
                                        </label>
                                        <label class="radio">
                                            <input type="radio" name="active_status" value="Inactive" {{ (isset($training_center['active_status'])&&$training_center['active_status']=='Inactive')||(old('active_status') == 'Inactive')?'checked':'' }}  > No<span></span>
                                        </label>
